...
- Genetic Algorithm is used here to find the best place for embedding modified secret data in host image to achieve high level of security and maximized PSNR(peak-signal to noise ratio) of stego image. Given below are some different scanning starting points in differnet directions.
